...
public class Protocol_2 extends AppCompatActivity {
    CheckBox checkBox;
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            if (checkBox.isChecked()) {
                ...
                Intent intent = new Intent(Protocol_2.this, Protocol_3.class);
                startActivity(intent);
            } else {
                // Show a toast message
                Toast.makeText(Protocol_2.this, "Please click on the checkbox before proceeding.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}