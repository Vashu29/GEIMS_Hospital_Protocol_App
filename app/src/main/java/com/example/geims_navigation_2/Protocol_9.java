...
public class Protocol_9 extends AppCompatActivity {
    CheckBox checkBox;
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocol9);
        ...
        nextButton.setOnClickListener(v -> {
            if (checkBox.isChecked()) {
                ...
                Intent intent = new Intent(Protocol_9.this, Protocol_10.class);
                startActivity(intent);
            } else {
                // Show a toast message
                Toast.makeText(Protocol_9.this, "Please click on the checkbox before proceeding.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}