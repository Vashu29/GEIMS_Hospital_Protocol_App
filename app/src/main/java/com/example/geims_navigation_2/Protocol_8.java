...
public class Protocol_8 extends AppCompatActivity {
    CheckBox checkBox;
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocol8);
        ...
        nextButton.setOnClickListener(v -> {
            if (checkBox.isChecked()) {
                ...
                Intent intent = new Intent(Protocol_8.this, Protocol_9.class);
                startActivity(intent);
            } else {
                // Show a toast message
                Toast.makeText(Protocol_8.this, "Please click on the checkbox before proceeding.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}