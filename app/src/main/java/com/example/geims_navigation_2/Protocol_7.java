...
public class Protocol_7 extends AppCompatActivity {
    CheckBox checkBox;
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocol7);
        ...
        nextButton.setOnClickListener(v -> {
            if (checkBox.isChecked()) {
                ...
                Intent intent = new Intent(Protocol_7.this, Protocol_8.class);
                startActivity(intent);
            } else {
                // Show a toast message
                Toast.makeText(Protocol_7.this, "Please click on the checkbox before proceeding.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}