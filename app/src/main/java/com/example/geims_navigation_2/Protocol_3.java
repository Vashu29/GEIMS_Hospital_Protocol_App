...
public class Protocol_3 extends AppCompatActivity {
    CheckBox checkBox;
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocol3);
        ...
        nextButton.setOnClickListener(v -> {
            if (checkBox.isChecked()) {
                ...
                Intent intent = new Intent(Protocol_3.this, Protocol_4.class);
                startActivity(intent);
            } else {
                // Show a toast message
                Toast.makeText(Protocol_3.this, "Please click on the checkbox before proceeding.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}